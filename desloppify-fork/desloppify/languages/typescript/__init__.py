"""TypeScript/Vue 3 language configuration for desloppify (ComfyUI fork)."""
...
from desloppify.languages.typescript.phases_vue import phase_vue
...
from desloppify.languages.typescript.review_comfy import (
    COMFY_HOLISTIC_REVIEW_DIMENSIONS as TS_HOLISTIC_REVIEW_DIMENSIONS,
    COMFY_MIGRATION_PATTERN_PAIRS as TS_MIGRATION_PATTERN_PAIRS,
    COMFY_REVIEW_GUIDANCE as TS_REVIEW_GUIDANCE,
)
        ...
        super().__init__(
            ...
            phases=[
                ...
                *_ts_treesitter_phases(),
                ...
                DetectorPhase("Vue 3 conventions", phase_vue),
                detector_phase_security(),
                *shared_subjective_duplicates_tail(),
            ],
            ...
            boundaries=[
                BoundaryRule("base/", "platform/", "base→platform"),
                BoundaryRule("base/", "workbench/", "base→workbench"),
                BoundaryRule("base/", "renderer/", "base→renderer"),
                BoundaryRule("platform/", "workbench/", "platform→workbench"),
